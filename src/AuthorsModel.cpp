...
AuthorsModel::AuthorsModel(QObject *parent) : QAbstractItemModel(parent)
{
}
        ...
        case 4:
          {
            ...
            auto it_auth
                = std::find_if(it->subelements.begin(), it->subelements.end(),
                               [this](const UDBElement &el)
                                 {
                                   return bid.getId(el) == BaseID::HomePage;
                                 });
            if(it_auth != it->subelements.end())
              {
                it_auth->content = str.toStdString();
        ...
        case 5:
          {
            ...
            auto it_auth
                = std::find_if(it->subelements.begin(), it->subelements.end(),
                               [this](const UDBElement &el)
                                 {
                                   return bid.getId(el) == BaseID::EMail;
                                 });
            if(it_auth != it->subelements.end())
              {
                it_auth->content = str.toStdString();
        ...
        case 6:
          {
            ...
            auto it_auth
                = std::find_if(it->subelements.begin(), it->subelements.end(),
                               [this](const UDBElement &el)
                                 {
                                   return bid.getId(el) == BaseID::AuthorID;
                                 });
            if(it_auth != it->subelements.end())
              {
                it_auth->content = str.toStdString();
